...
def get_user_past_interactions(user_id):
    '''
    사용자 평점 데이터 중 4점 이상(선호했다는 정보)만 가져오기
    '''
...
# streamlit run show_st2.py --client.showErrorDetails=false
